...
public class SplashActivity extends AppCompatActivity {
    ...
    private void addOnClickListenersOnButtons() {
        ...
        addOnRegisterClickListener();
        addOnAnonymousClickListener();
    }
    ...
    private void addOnRegisterClickListener() {
    ...
    private void addOnAnonymousClickListener() {
